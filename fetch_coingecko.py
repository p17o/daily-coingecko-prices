...
coins = [
    ...
    "ethereum", "ethereum-pow-iou", "kava", "kusama", "chainlink", "litecoin",
    "terra-luna", "terra-luna-2", "matic-network", "nym", "orchid-protocol", "solana", "storj",
    "starknet", "uniswap", "tether", "terrausd", "tezos"
]
    ...
    for attempt in range(10):
        try:
            ...
            if r.status_code == 200:
                ...
                eur = prices.get("eur", "")
                chf = prices.get("chf", "")
                return [date_str, coin, coin_symbol, coin_name, usd, eur, chf]
            else:
                time.sleep(2)
        except Exception:
            time.sleep(2)
...
for coin in coins:
    ...
    with open(filename, "a", newline="") as csvfile:
        ...
        if not file_exists:
            writer.writerow(["date", "coingecko_coin_id", "coin_symbol", "coin_name", "price_usd", "price_eur", "price_chf"])
        writer.writerow(row)
